...
class ToursListTest extends TestCase
{
    ...
    public function test_tours_list_sortes_by_starting_date_correctly(): void
    {
        $travel = Travel::factory()->create();
    ...
    public function test_tours_list_sortes_by_price_correctly(): void
    {
        $travel = Travel::factory()->create();
    ...
    public function test_tour_list_return_validation_error(){
        $travel=Travel::factory()->create();
