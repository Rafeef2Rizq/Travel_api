...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: [
        {
            &quot;id&quot;: &quot;01997fa5-8484-728a-ac91-3febffcc5d2c&quot;,
            &quot;name&quot;: &quot;tour cairo&quot;,
            &quot;slug&quot;: &quot;cairo&quot;,
            &quot;description&quot;: &quot;desc after update&quot;,
            &quot;number_of_days&quot;: 1,
            &quot;number_of_nights&quot;: 0
        }
    ],
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/travels/01997be9-2b19-70f0-9f72-128f1b0fe2b4/tours" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"priceFrom\": 4326.41688,
    \"priceTo\": 4326.41688,
    \"dateFrom\": \"2025-09-25T08:28:15\",
    \"dateTo\": \"2025-09-25T08:28:15\",
    \"sortBy\": \"price\",
    \"sortOrder\": \"desc\"
}"
</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/travels/01997be9-2b19-70f0-9f72-128f1b0fe2b4/tours"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;No query results for model [App\\Models\\Travel] 01997be9-2b19-70f0-9f72-128f1b0fe2b4&quot;
}</code>
 </pre>
    </span>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="01997be9-2b19-70f0-9f72-128f1b0fe2b4"
               data-component="url">
    <br>
<p>The slug of the travel. Example: <code>01997be9-2b19-70f0-9f72-128f1b0fe2b4</code></p>
            </div>
...
<i>optional</i> &nbsp;
               ...
               value="2025-09-25T08:28:15"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-09-25T08:28:15</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/admin/travels/01997be9-2b19-70f0-9f72-128f1b0fe2b4/tours" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"architecto\",
    \"starting_date\": \"2025-09-25T08:28:15\",
    \"ending_date\": \"2051-10-19\",
    \"price\": 4326.41688
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the travel. Example: <code>01997be9-2b19-70f0-9f72-128f1b0fe2b4</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>starting_date</code>. Example: <code>2051-10-19</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    "http://localhost:8000/api/v1/admin/travels/01997be9-2b19-70f0-9f72-128f1b0fe2b4" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"is_public\": true,
